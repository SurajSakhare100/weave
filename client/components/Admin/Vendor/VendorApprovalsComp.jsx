...
function VendorApprovalsComp({ loaded, setLoaded }) {
    ...
    if (!loaded) return <LoadingSpinner text="Loading vendor applications..." />
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Vendor Approval Management</h1>
                        <p className="text-gray-600 mt-1">Review and manage vendor applications</p>
                    </div>
                    <div className="flex items-center space-x-2">
                        <FileText className="h-6 w-6 text-blue-600" />
                        <span className="text-sm text-gray-500">Approval Workflow</span>
                    </div>
                </div>
            </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <div className="flex-1">
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    placeholder="Search vendor applications..."
                                    value={searchTerm}
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-500">
                            {statusFilter === 'approved' ? 'No approved vendors yet.' : 
                             statusFilter === 'pending' ? 'No pending applications to review.' :
                                    ...
                                    <p><span className="font-medium">Status:</span>
                                        <span className={`ml-2 inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getVendorStatusColor(viewModal.vendor.status)}`}>
                                            {viewModal.vendor.status === 'approved' ? 'Approved' : 
                                             viewModal.vendor.status === 'pending' ? 'Pending Review' : 
            ...
            <BaseModal
                ...
                title={`${feedbackModal.action === 'approve' ? 'Approve' : 'Reject'} Vendor Application`}
                size="md"
            >
                <div className="space-y-4">
                    <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600">
                            <span className="font-medium">Applicant:</span> {feedbackModal.vendor?.name || feedbackModal.vendor?.adharName}
                        </p>
                        <p className="text-sm text-gray-600">
                    ...
                    <div className="flex justify-end space-x-3 pt-4">
                        ...
                        >
                            {feedbackModal.action === 'approve' ? 'Approve Application' : 'Reject Application'}
                        </button>
                    </div>
                </div>
            </BaseModal>
...
export default VendorApprovalsComp 