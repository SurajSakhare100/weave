  ...
  return (
    <footer className="bg-primary text-white ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-[#e5d6c3]">Email: info@weave.com</p>
              <p className="text-[#e5d6c3]">Phone: +1 (555) 123-4567</p>
              <div className="flex space-x-4 mt-4">
                <a href="#" className="text-[#e5d6c3] hover:text-white transition-colors">
        ...
        <div className="mt-8 pt-8 border-t border-[#e5d6c3] text-center">
          <p className="text-[#e5d6c3]">
