  ...
  return (
    <section className="relative h-[500px] bg-cover bg-center" style={{ backgroundImage: "url('/landing/newArrival.png')" }}>
      <div className="relative z-10 flex flex-col items-start justify-center h-full container mx-auto px-4">
        ...
        <p className="text-white mt-2 text-lg">Check out our latest collection</p>
        <Link href="/shop/new-arrivals" className="mt-6 border border-white text-white px-8 py-3 rounded-md hover:bg-white hover:text-black transition-colors text-base font-semibold">
            View Collection
        </Link>
      </div>
    </section>
